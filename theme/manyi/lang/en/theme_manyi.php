...
<p>Visit the admin settings to change colours, add an image as a background, add your logo and manyi.</p>';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'The logo is only displayed in the header of the front page and login page.<br /> If the height of your logo is manyi than 75px add div.logo {height: 100px;} to the Custom CSS box below, amending accordingly if the height is other than 100px. If a logo is not added here, the logo in Appearance > Logos will be used.';

$string['pluginname'] = 'Manyi is awesome'; //changed this from 'more' to 'manyi' //
...
$string['footertextcolor_desc'] = 'The colour of the footer';
$string['h2color'] = 'Header 2 colour';
$string['h2color_desc'] = 'The colour of header 2';

$string['phover'] = 'Hover colour';
$string['phover_desc'] = 'The colour that pops up when you hover';
$string['fontsize'] = 'Font size';
$string['fontsize_desc'] = 'The size of the font';
$string['file'] = 'Cool image';
$string['file_desc'] = 'Insert cool image';
